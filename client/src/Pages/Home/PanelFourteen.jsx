...
const AdvertisementFive = () => {
  return (
    <div className='row18 h-auto flex flex-col items-center'>
        <div className="w-full flex items-center justify-center">
            <h1 className="font-extrabold">🌸 Easy-Breeze Discount 🌸</h1>
        </div>
        <div className="w-11/12 grid grid-cols-2 lg:grid-cols-6 items-center justify-center gap-5 !p-2">
            {advertiseMent?.map(() => (
